...
router.delete('/deleteLatestRendering', delete_rendering_image);
router.delete('/deleteSelectYourBudget', delete_rendering_image);
router.delete('/deleteSelectYourRoom', delete_rendering_image);
router.delete('/deleteSelectYourStyle', delete_rendering_image);
router.delete('/deleteSelectYourFurniture', delete_rendering_image);
